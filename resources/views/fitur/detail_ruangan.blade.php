    ...
    <div class="container py-3">
        <header>
            ...
            <div class="pricing-header mx-auto text-center">
                ...
                <img src="{{ asset('storage/' . $data->foto_ruangan) }}"alt="foto ruangan" width="250" height="250">
                ...
                <table class="table ">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="/authDsn/{{ Crypt::encrypt($data->id_ruangan) }}"  target="_blank" class="btn btn-success btn-sm"> Use it!  </a>
